...
IniWrite(@ScriptDir & "\settings.ini", "options", "submitpageshow", "0") ; Tell the program to show the submit jobs webpage 1 = on 0 = off
...
If $nMsg = $MenuItem43 Then Call("_featurenotaval") ; Enable Meta Include On/Off
If $nMsg = $MenuItem44 Then Call("_featurenotaval") ; Enable Meta Exclude On/Off
If $nMsg = $MenuItem45 Then Call("_featurenotaval") ; Edit Meta Include file
If $nMsg = $MenuItem46 Then Call("_featurenotaval") ; Edit Meta Exclude file
...
; # TALK #
If GUICtrlRead($Checkbox1) = 1 Then _TalkOBJ("The End, Lekke to be Saffa!")
; # APP SPEED #
Sleep(IniRead(@ScriptDir & "\settings.ini","options","prospeed", "10"))
